...
def parse_args():
    ...
    parser.add_argument("--max_tokens_per_call", default=8000, type=int)
...
def main(llm, tokenizer, data_name, args):
    ...
    # -------------------------------------------------------
    # Extra pass@k metrics when we generated >1 sample AND n is a power of two
    # -------------------------------------------------------
    if args.n_sampling > 1 and (args.n_sampling & (args.n_sampling - 1) == 0):
        # powers of two up to n_sampling, starting with 1
        ...
        # store in the metrics file that’s dumped below
