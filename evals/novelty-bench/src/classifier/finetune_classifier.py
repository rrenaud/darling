...
#TRAIN_FILE = "data/classifier/train.jsonl" this is hte data for instruction following 
#VAL_FILE = "data/classifier/val.jsonl"
TRAIN_FILE = "/checkpoint/ram/tianjian/math_cots/deepscaler/ds_train_o3.jsonl" # this is the data for math
VAL_FILE = "/checkpoint/ram/tianjian/math_cots/deepscaler/ds_val_o3.jsonl"
...
def main():
    ...
    with tqdm(total=TRAIN_STEPS) as pbar:
        for i in range(TRAIN_STEPS):
            ...
            if i != 0 and i % 10 == 0:
                ...
                #model.load_state_dict(torch.load(os.path.join(OUTPUT_DIR, f"model-{i}.pt")))
    ...
    for step in range(TRAIN_STEPS):
        if step % 10 == 0 and step != 0:
            ...
            model.load_state_dict(torch.load(os.path.join(OUTPUT_DIR, f"model-{step}.pt")))
            model.to(DEVICE)
            model.eval()
